...
class _RedditSliderState extends State<RedditSlider> {
  ...
  _fetchImages() async{
    ...
    final response = await http.get('https://www.reddit.com/r/$activeSubreddit/.json?limit=15');
  ...
  _buildSubredditPage(){
    return Column(
      ...
      children: <Widget>[        
        Text('SubReddit',style: TextStyle(fontSize: 40.0, fontWeight: FontWeight.bold),),
        Text('Choose',style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold),),
